...
<body>
  ...
  <script src="{{url('/template-resources/admin/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
  <script src="{{url('/template-resources/admin/assets/js/sidebarmenu.js')}}"></script>
  ...
  <script type="text/javascript" src="{{url('/template-resources/admin/assets/tiny_mce/tiny_mce.js')}}"></script>
