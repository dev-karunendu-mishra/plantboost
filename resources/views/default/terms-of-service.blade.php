<x-default-app-layout :siteSettings="$siteData">
    <div class="container">
        ...
        <p>By visiting our site and/ or purchasing something from us, you engage in our “Service” and agree to be bound
            ...
            or contributors of content.</p><br>
        <p>Please read these Terms of Service carefully before accessing or using our website. By accessing or using any
            ...
            Service are considered an offer, acceptance is expressly limited to these Terms of Service.</p><br>
        <p>Any new features or tools which are added to the current store shall also be subject to the Terms of Service.
            ...
            access to the website following the posting of any changes constitutes acceptance of those changes.</p><br>
        <p>Our store is hosted on Shopify Inc. They provide us with the online e-commerce platform that allows us to
            sell our products and services to you.</p><br>
        ...
        <p>You agree not to reproduce, duplicate, copy, sell, resell or exploit any portion of the Service, use of the
            ...
            without express written permission by us.</p><br>
        ...
        <p>We are not responsible if information made available on this site is not accurate, complete or current. The
            ...
            sources of information. Any reliance on the material on this site is at your own risk.</p><br>
        <p>This site may contain certain historical information. Historical information, necessarily, is not current and
            ...
            monitor changes to our site.</p><br>
        <p><br></p>
        ...
        <p><br></p>
        <p>Questions about the Terms of Service should be sent to us at support@plantboost.in</p>
    </div>
