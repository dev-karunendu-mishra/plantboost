<x-default-app-layout :siteSettings="$siteData">
    <div class="container">
        ...
        <div class="marquee-two position-relative" style="height: 100px;">
            ...
            <marquee class="text-white fw-bold position-relative" behavior="scrolling" direction="left"
                style="bottom: -55px;">Plant Boost’s Organic Plant Booster is the best choice for your Pet!!</marquee>
        </div>

        <div class="review-slider">
            <div>
                <img src="{{url('assets/img/Snapshot_22.PNG')}}" alt="" class="img-fluid">
                <h5>One</h5>
            </div>
            <div>
                <img src="{{url('assets/img/Snapshot_23.PNG')}}" alt="" class="img-fluid">
                <h5>Two</h5>
            </div>
            <div>
                <img src="{{url('assets/img/Snapshot_26.PNG')}}" alt="" class="img-fluid">
                <h5>Three</h5>
            </div>
            <div>
                <img src="{{url('assets/img/Snapshot_27.PNG')}}" alt="" class="img-fluid">
                <h5>Four</h5>
            </div>
            <div>
                <img src="{{url('assets/img/Snapshot_29.PNG')}}" alt="" class="img-fluid">
                <h5>Five</h5>
            </div>
            <div>
                <img src="{{url('assets/img/Snapshot_30.PNG')}}" alt="" class="img-fluid">
                <h5>Six</h5>
            </div>
        </div>
