            ...
            <div class="modal-body">
                ...
                <form action="{{route('placeOrder')}}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="mobile" style="width: 40px;"><i class="fa fa-mobile"></i></span>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="address_line_one" style="width: 40px;"><i class="fa fa-map-marker"></i></span>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="address_line_two" style="width: 40px;"><i class="fa fa-map-marker"></i></span>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="pin" style="width: 40px;"><i class="fa fa-hashtag"></i></span>
                        <input id="pincode" name="pin" type="text" class="form-control" placeholder="Pincode"
                            aria-label="Pincode" aria-describedby="pin">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="city" style="width: 40px;"><i class="fa fa-map-marker"></i></span>
